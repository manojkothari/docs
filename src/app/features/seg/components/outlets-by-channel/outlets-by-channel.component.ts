...
import { Category, UpdateCategory } from 'src/app/features/rgm/models/category.model';
import { RgmService } from 'src/app/features/rgm/services/rgm.service';

@Component({
  selector: 'app-outlets-by-channel',
  templateUrl: './outlets-by-channel.component.html',
  styleUrls: ['./outlets-by-channel.component.scss']
})
export class OutletsByChannelComponent implements OnInit {
